...
// UNPAIR is intentionally a physical, local-only reset command.  It lets a
// gateway release every hanger before its own Wi-Fi/account setup is cleared.
enum class Command:uint8_t{LED_BLINK=1,LED_OFF=2,UNPAIR=3,PAIR=4};
