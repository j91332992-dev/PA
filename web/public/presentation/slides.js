(function () {
  ...
  const slides = [
    { name: '오프닝 / 아침 영상', short: 'OPENING', time: '0:35', file: 'slides/story/01-hook.html?v=20260819-08' },
    { name: '핵심 질문', short: 'QUESTION', time: '0:35', file: 'slides/story/02-question.html?v=20260819-09' },
    { name: '제목·팀 소개', short: 'INTRO', time: '0:25', file: 'slides/story/03-intro-clean.html?v=20260819-34' },
    ...
    { name: '사용자 조사', short: 'EVIDENCE', time: '0:35', file: 'slides/story/06-evidence.html?v=20260819-13' },
    { name: '문제 02 / 기억', short: 'MEMORY', time: '0:30', file: 'slides/story/07-memory-problem.html' },
    { name: '시장 분석', short: 'MARKET', time: '0:40', file: 'slides/story/08-market.html?v=20260819-12' },
    ...
    { name: '시스템 동작 원리', short: 'SYSTEM FLOW', time: '1:00', file: 'slides/story/11-system.html?v=20260819-37' },
